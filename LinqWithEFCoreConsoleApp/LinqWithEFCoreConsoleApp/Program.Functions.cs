...
partial class Program
{
    static void FilterAndSort()
    {
        ...
        using (SQLiteDatabase db = new())
        {
            ...
            /*            IQueryable<Product> filteredProducts = allProducts.Where(
    ...
    static void AggregateProducts()
    {
        ...
        using (SQLiteDatabase db = new())
        {
            ...
            {
                WriteLine("{0,-25} {1,10}", arg0: "Product count from DbSet:", arg1: countDbSet);
            }
            else
            {
            ...
            {
                WriteLine("{0,-25} {1,10}", arg0: "Product count from list:", arg1: countList);
            }
            else
            {
            ...
            WriteLine(
                "{0,-27} {1,8}", // Note the different column widths.
    ...
    static void OutputPageOfProducts(
